...
|---|---|---|---|---|---|---|---|---|---|
| 10_whale | 30% whale | 1.000 | 1.000 | 1.000 | 1 | 0.0 | 0.0% | 1.199 | 0.0 |
| 11_funding | 30% fund | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.257 | 0.0 |
| 12_armageddon | 50% no bnce | 1.000 | 1.000 | 1.000 | 1 | 0.0 | 0.0% | 1.186 | 0.0 |
| 13_skew_lag5 | 30% lag5 | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.245 | 0.0 |
| 14_armageddon_lag5 | stair lag5 | 1.000 | 1.000 | 1.000 | 1 | 0.0 | 0.0% | 1.190 | 0.0 |
| 15_armageddon_lag20 | stair lag20 | 1.000 | 1.000 | 1.000 | 1 | 0.0 | 0.0% | 1.207 | 0.0 |
| 1_baseline | 30% bounce | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.257 | 0.0 |
| 2_flash | 40% bounce | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.232 | 0.0 |
| 3_slowbleed | 50%/500s | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.527 | 0.0 |
| 4_noinsurance | 30% no ins | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.257 | 0.0 |
| 5_tinylp | 30% sm LP | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.257 | 0.0 |
| 6_degens | 20% 2.5%IM | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.165 | 0.0 |
| 7_skew90 | 30% 90%skew | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.245 | 0.0 |
| 8_staircase | 3x15% | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.407 | 0.0 |
| 9_oracle | 20% distort | 1.000 | 1.000 | 1.000 | 4 | 1.0 | 40.0% | 0.000 | 0.0 |
| adl_a_decay | 70% 2%IM | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.889 | 0.0 |
| adl_cascade | 70% batch | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.658 | 0.0 |
| adl_drain_reset | 80% 1.5%IM | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.839 | 0.0 |
| adl_k_deficit | 50% K | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.603 | 0.0 |
| adl_stale | 60% bnce | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.632 | 0.0 |
| adl_trigger | 60% no ins | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.719 | 0.0 |
...
| ten10_alt | Alt 80% | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.561 | 0.0 |
| ten10_btc | BTC 14% | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.172 | 0.0 |
| ten10_hl | BTC noI | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.186 | 0.0 |
| ten10_sol | SOL 40% | 1.000 | 1.000 | 1.000 | 0 | 0.0 | 0.0% | 1.299 | 0.0 |

## Focused Tests

| Test | Result |
|---|---|
| --test=audit | Fee asymmetry FIXED (both charged), risk-reducing exemption works, ADL pipeline pass |
...
2. **A/K fairness**: deficit-ordered keeper gives 0.00%% fairness error across fuzz seeds
3. **No overhang**: after ADL, pnl_pos_tot returns to 0, h returns to 1.0
